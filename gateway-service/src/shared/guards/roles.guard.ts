...
export class RolesGuard implements CanActivate {
    public constructor(private readonly reflector: Reflector, private readonly accountClient: AccountClientGrpc) {}
    ...
    public async canActivate(context: ExecutionContext): Promise<boolean> {
        ...
        if(!required.includes(account.role)) throw new ForbiddenException(
