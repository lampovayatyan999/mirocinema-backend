...
export class GrpcMetricsInterceptor implements NestInterceptor {
    ...
    public constructor(
        @InjectMetric('grpc_requests_total') private readonly counter: Counter<string>,
        @InjectMetric('grpc_request_duration_seconds') private readonly histogram: Histogram<string>,
    ) {
